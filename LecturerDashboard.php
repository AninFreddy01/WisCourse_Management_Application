...
<body>
 ...
 <div class="container">
       ...
       <div class="col-sm-3">
      <button type="button"  onclick="javascript:window.location='upload_course.html'" class="btn btn-default" style="font-size : 50px;" >
	   <small style="font-size:20px;">Upload Course Materials</small><br >
        <span class="glyphicon glyphicon-book" aria-hidden="true"></span>
      </button>
      </div>
	  
	     <div class="col-sm-3">
      <button type="button"  onclick="javascript:window.location='add.html'" class="btn btn-default" style="font-size : 50px;" >
